...
interface ProjectCardProps {
  project: {
    ...
    endDate: Date | string;
    members?: Array<{ student?: { name: string; avatarUrl?: string | null }; name?: string }>;
    tags?: Array<{ tag?: { name: string; color: string }; name?: string; color?: string }>;
  };
  href: string;
}
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2">
            <Badge variant={statusColors[status] as any}>{status.replace("_", " ")}</Badge>
          </div>
