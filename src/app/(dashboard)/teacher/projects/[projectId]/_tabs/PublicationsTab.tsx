      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Publication points</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Student Score</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Per student share</p>
          </CardContent>
        </Card>
      </div>
